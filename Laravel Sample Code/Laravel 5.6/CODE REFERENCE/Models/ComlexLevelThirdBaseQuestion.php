...
class ComlexLevelThirdBaseQuestion extends Model {
     ...
     * @var string
     */
    protected $table = 'comlex_level_3_base_questions';
    ...
    public static function addUpdateQuestion( $vars = null ){
        $question = ComlexLevelThirdBaseQuestion::firstOrNew(['id' => isset($vars['id']) ? $vars['id'] : '']);
    ...
    public static function getQuestions($limit = NULL){
        $questions = ComlexLevelThirdBaseQuestion::orderBy('id', 'desc')->paginate($limit);
        return $questions;
    }
    
    public static function getSetsQuestions($limit = NULL){
        $questions = ComlexLevelThirdBaseQuestion::with('mainQuestions')
                            ->where('type','sets')
                            ->orderBy('id', 'desc')
                            ->paginate($limit);
        return $questions;
    ...
    {
        return $this->hasMany('App\Models\ComlexLevelThirdQuestion','parent');
    }
