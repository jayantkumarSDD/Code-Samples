...
class ComlexLevelFirstDimensionFirstQbankCategory extends Model {
     ...
     * @var string
     */
    protected $table = 'comlex_level_first_d1_categories';
        ...
        if (!$cats->isEmpty()) {
            foreach ($cats as $val):
                ...
                $html .= '<td>
                                     ...
                                     ';
                $html .= '<td>
			<a href="/admin/comlex_level_first_d1_qbankcategory?id=' . $val->id . '"><i class="fa fa-edit"></i></a>
